...
|------|-------|-------------|
| `--description <text>` | `-d` | Description text for the tag |
| `--remove` | | Remove the tag description |

**Modes:**
- `mdp project tag-describe <tag> -d "text"` — Set or update the description
- `mdp project tag-describe <tag>` — View the current description
- `mdp project tag-describe <tag> --remove` — Remove the description
...
```json
{
  ...
  "data": {
    "tag": "acme",
    "description": "Acme Corp — B2B SaaS for supply chain management"
  }
}
```
...
```json
{
  ...
  "data": {
    "tags": [
      { "tag": "acme", "description": "Acme Corp — B2B SaaS for supply chain management", "projectCount": 2 },
      { "tag": "personal", "description": null, "projectCount": 1 }
    ],
    "total": 2
  }
}
